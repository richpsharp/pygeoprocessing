...
def fill_pits(
    ...
    Parameters:
        ...
        max_pit_size (int): pits that are larger than this size in pixels will
            not be filled. This is to guard against large natural depressions
            in a landscape that should not be filled.
